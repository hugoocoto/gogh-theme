-- This file is copied verbatim by build.sh into lua/base16-colorscheme.lua.
-- Edit it here, not the copy in lua/ — that one is build output.
--
-- Applies a base16 (https://github.com/tinted-theming/base16) color palette
-- as Neovim highlight groups.
--
-- Highlight groups adapted from the base16-nvim template
-- (https://github.com/wincent/base16-nvim) by Greg Hurrell
-- (https://github.com/wincent), itself based on base16-vim
-- (https://github.com/chriskempson/base16-vim) by Chris Kempson and its
-- fork tinted-vim (https://github.com/tinted-theming/tinted-vim).

local M = {}

-- colors: a table with hex string values (e.g. "#1d2021") for keys
-- base00..base0F.
function M.setup(colors)
  local gui00, gui01, gui02, gui03 = colors.base00, colors.base01, colors.base02, colors.base03
  local gui04, gui05, gui06, gui07 = colors.base04, colors.base05, colors.base06, colors.base07
  local gui08, gui09, gui0A, gui0B = colors.base08, colors.base09, colors.base0A, colors.base0B
  local gui0C, gui0D, gui0E, gui0F = colors.base0C, colors.base0D, colors.base0E, colors.base0F

  -- Base24 colors are not defined for base16 schemes; fall back to the
  -- base16 equivalents documented by the base16-nvim template.
  local gui10, gui11 = gui00, gui00
  local gui12, gui13, gui14, gui15, gui16, gui17 = gui08, gui0A, gui0B, gui0C, gui0D, gui0E

  -- Standard base16 terminal ANSI color assignment.
  local cterm00, cterm03, cterm05, cterm07 = 0, 8, 7, 15
  local cterm08, cterm0A, cterm0B, cterm0C = 1, 3, 2, 6
  local cterm0D, cterm0E, cterm01, cterm02 = 4, 5, 10, 11
  local cterm04, cterm06, cterm09, cterm0F = 12, 13, 9, 14

  local cterm10, cterm11 = cterm00, cterm00
  local cterm12, cterm13, cterm14 = cterm08, cterm0A, cterm0B
  local cterm15, cterm16, cterm17 = cterm0C, cterm0D, cterm0E
  ...
  vim.api.nvim_set_hl(0, 'Normal', { fg = gui05, bg = 'NONE', ctermfg = cterm05, ctermbg = 'NONE' })
  ...
  vim.api.nvim_set_hl(0, 'FoldColumn', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'Folded', { fg = gui03, bg = gui02, ctermfg = cterm03, ctermbg = cterm02 })
  ...
  vim.api.nvim_set_hl(0, 'LineNr', { fg = gui03, ctermfg = cterm03 })
  vim.api.nvim_set_hl(0, 'SignColumn', { fg = gui03, ctermfg = cterm03 })
  vim.api.nvim_set_hl(0, 'StatusLine', { fg = gui04, bg = gui02, ctermfg = cterm04, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = gui03, bg = gui02, ctermfg = cterm03, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'VertSplit', { fg = gui02, bg = gui02, ctermfg = cterm02, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'ColorColumn', { bg = gui02, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'CursorColumn', { bg = gui02, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'CursorLine', { bg = gui02, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = gui04, ctermfg = cterm04 })
  vim.api.nvim_set_hl(0, 'QuickFixLine', { bg = gui02, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'PMenu', { fg = gui05, bg = gui02, ctermfg = cterm05, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'PMenuSel', { fg = gui01, bg = gui05, ctermfg = cterm01, ctermbg = cterm05 })
  vim.api.nvim_set_hl(0, 'TabLine', { fg = gui03, bg = gui02, ctermfg = cterm03, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'TabLineFill', { fg = gui03, ctermfg = cterm03 })
  vim.api.nvim_set_hl(0, 'TabLineSel', { fg = gui0B, ctermfg = cterm0B })

  -- Standard syntax highlighting
  vim.api.nvim_set_hl(0, 'Boolean', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Character', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Comment', { fg = gui03, ctermfg = cterm03 })
  vim.api.nvim_set_hl(0, 'Conditional', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Constant', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Define', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Delimiter', { fg = gui0F, ctermfg = cterm0F })
  vim.api.nvim_set_hl(0, 'Float', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Function', { fg = gui0D, ctermfg = cterm0D })
  vim.api.nvim_set_hl(0, 'Identifier', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Include', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Keyword', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Label', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'Number', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Operator', { fg = gui05, ctermfg = cterm05 })
  vim.api.nvim_set_hl(0, 'PreProc', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'Repeat', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Special', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'SpecialChar', { fg = gui0F, ctermfg = cterm0F })
  vim.api.nvim_set_hl(0, 'Statement', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'StorageClass', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'String', { fg = gui0B, ctermfg = cterm0B })
  vim.api.nvim_set_hl(0, 'Structure', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'Tag', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'Todo', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'Type', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'Typedef', { fg = gui0C, ctermfg = cterm0C })

  -- C highlighting
  vim.api.nvim_set_hl(0, 'cOperator', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'cPreCondit', { fg = gui08, ctermfg = cterm08 })

  -- C# highlighting
  vim.api.nvim_set_hl(0, 'csClass', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'csAttribute', { fg = gui0C, ctermfg = cterm0C })
  vim.api.nvim_set_hl(0, 'csModifier', { fg = gui08, ctermfg = cterm08 })
  ...
  vim.api.nvim_set_hl(0, 'csContextualStatement', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'csNewDecleration', { fg = gui08, ctermfg = cterm08 })

  -- CSS highlighting
  vim.api.nvim_set_hl(0, 'cssBraces', { fg = gui05, ctermfg = cterm05 })
  vim.api.nvim_set_hl(0, 'cssClassName', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'cssColor', { fg = gui0C, ctermfg = cterm0C })

  -- Diff highlighting
  vim.api.nvim_set_hl(0, 'DiffAdd', { fg = gui0B, bg = gui02, ctermfg =  cterm0B, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiffChange', { fg = gui03, bg = gui02, ctermfg =  cterm03, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiffDelete', { fg = gui08, bg = gui02, ctermfg =  cterm08, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiffText', { fg = gui0D, bg = gui02, ctermfg =  cterm0D, ctermbg = cterm02 })
  ...
  vim.api.nvim_set_hl(0, 'GitGutterAdd', { fg = gui0B, bg = gui02, ctermfg = cterm0B, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'GitGutterChange', { fg = gui0D, bg = gui02, ctermfg = cterm0D, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'GitGutterDelete', { fg = gui08, bg = gui02, ctermfg = cterm08, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'GitGutterChangeDelete', { fg = gui0E, bg = gui02, ctermfg = cterm0E, ctermbg = cterm02 })
  ...
  vim.api.nvim_set_hl(0, 'javaScriptNumber', { fg = gui08, ctermfg = cterm08 })

  -- pangloss/vim-javascript highlighting
  vim.api.nvim_set_hl(0, 'jsOperator', { fg = gui0D, ctermfg = cterm0D })
  vim.api.nvim_set_hl(0, 'jsStatement', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'jsReturn', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'jsThis', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'jsClassDefinition', { fg = gui0A, ctermfg = cterm0A })
  vim.api.nvim_set_hl(0, 'jsFunction', { fg = gui08, ctermfg = cterm08 })
  ...
  vim.api.nvim_set_hl(0, 'jsClassMethodType', { fg = gui08, ctermfg = cterm08 })
  ...
  vim.api.nvim_set_hl(0, 'DiagnosticUnderlineHint', { ctermfg = cterm00, ctermbg = cterm03, underline = true, sp = gui03 })
  vim.api.nvim_set_hl(0, 'DiagnosticUnderlineOk', { ctermfg = cterm00, ctermbg = cterm0B, underline = true, sp = gui0B })
  vim.api.nvim_set_hl(0, 'DiagnosticFloatingError', { fg = gui08, bg = gui02, ctermfg = cterm08, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiagnosticFloatingWarn', { fg = gui09, bg = gui02, ctermfg = cterm09, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiagnosticFloatingInfo', { fg = gui0C, bg = gui02, ctermfg = cterm0C, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiagnosticFloatingHint', { fg = gui03, bg = gui02, ctermfg = cterm03, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'DiagnosticFloatingOk', { fg = gui0B, bg = gui02, ctermfg = cterm0B, ctermbg = cterm02 })
  ...
  -- Python highlighting
  vim.api.nvim_set_hl(0, 'pythonOperator', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'pythonRepeat', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'pythonInclude', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'pythonStatement', { fg = gui08, ctermfg = cterm08 })

  -- Ruby highlighting
  vim.api.nvim_set_hl(0, 'rubyAttribute', { fg = gui0D, ctermfg = cterm0D })
  vim.api.nvim_set_hl(0, 'rubyConstant', { fg = gui08, ctermfg = cterm08 })
  ...
  vim.api.nvim_set_hl(0, 'sassInclude', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'sassMixing', { fg = gui08, ctermfg = cterm08 })
  vim.api.nvim_set_hl(0, 'sassMixinName', { fg = gui0D, ctermfg = cterm0D })

  -- Signify highlighting
  vim.api.nvim_set_hl(0, 'SignifySignAdd', { fg = gui0B, bg = gui02, ctermfg = cterm0B, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'SignifySignChange', { fg = gui0D, bg = gui02, ctermfg = cterm0D, ctermbg = cterm02 })
  vim.api.nvim_set_hl(0, 'SignifySignDelete', { fg = gui08, bg = gui02, ctermfg = cterm08, ctermbg = cterm02 })
  ...
  vim.api.nvim_set_hl(0, '@constant.builtin', { fg = gui08, ctermfg = cterm08, italic = true })
  ...
  vim.api.nvim_set_hl(0, '@type.builtin', { fg = gui0C, ctermfg = cterm0C, italic = true })
  ...
  vim.api.nvim_set_hl(0, '@keyword.import', { fg = gui08, ctermfg = cterm08, italic = true })
